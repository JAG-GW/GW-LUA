...
import pathlib
import sys
site_packages_path = r"C:\Program Files (x86)\Python313-32\Lib\site-packages"
...
class LuaBridge:
   ...
   def _setup_lua_environment(self):
    ...
    # ✅ Register CoreLib Before Running Lua
    if hasattr(Py4GW, "CoreLib"):
        self.lua.globals()['CoreLib'] = Py4GW.CoreLib
        print("[LuaBridge] CoreLib successfully registered.")
    else:
